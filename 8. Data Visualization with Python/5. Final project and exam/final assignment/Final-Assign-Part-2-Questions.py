...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(yearly_rec, 
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales per Year During Recession Period"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(
                ...
                names = 'Vehicle_Type',
                title='Total Advertising Expenditure Share by Vehicle Type during Recession Period'
        )
        )
...
# grouping data for plotting
        ...
        R_chart4  = dcc.Graph(
            ...
            title='Effect of Unemployment Rate on Vehicle Type and Sales (due to recession)'
            )
        )
